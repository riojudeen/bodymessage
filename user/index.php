...
<head>
	...
	<link  rel="icon" type="image/x-icon" href="../gambar/sistem/logo-mini-01.png">
			...
			<div class="col-12 col-md-3 kotak-kiri d-none d-sm-none d-md-block">
				...
				<div class="kotak-kiri-sidebar">
					...
					<nav class="navbar navbar-expand-lg navbar-light bg-light">
						...
						<h5 class="ml-2"> <?=$saya['user_nama']?> <small>(You)</small> </h5>
			...
			<div class="modal-content">
				<form action="profil_update.php" method="post" enctype="multipart/form-data">
					...
					<div class="modal-body">
						...
						<div class="form-group row">
							<label class="col-lg-2">NPK</label>
							<div class="col-lg-10" >
								<input type="number" name="email" class="form-control" value="<?php echo $saya['user_email']; ?>">
							</div>
						</div>
						<div class="form-group row">
